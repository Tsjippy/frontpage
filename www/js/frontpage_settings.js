...
var idx_Temp2 = '22';
var idx_Temp3 = '36';
var idx_Temp_buiten = '46';
var idx_Tempf = '0';
var idx_Iphone5s = '0';
var idx_Telefoon_m = '0';
var idx_Voordeur = '0'; //'207';
var idx_Garagedeur = '0'; //'208';
var idx_WindRichting = '53';
var idx_WindSnelheid = '53';
var idx_BewegingF = '0';
var idx_LuxF = '46';
var idx_LuxV = '46';
var idx_ZonV = '0';
var idx_ZonA = '0';
var idx_Barometer = '52';
var idx_Visibility = '54';
var idx_Usage1 = '0';
var idx_Usage2 = '0';
var idx_UsageTot1 = '0';
var idx_UsageTot2 = '0';
...
var idx_PC = '0';
var idx_TV = '0';
var idx_water_meter = '0';
var idx_doorbell = '0';
var idx_electricity_today = '0';
var idx_gas_today = '0';
var IsNight = 'No';
var idx_IsDarkVariable= '2';
var idx_ChromecastControl= '60';
var idx_ChromecastTitle= '62';
var idx_ChromecastVolume= '61';
var DarkUserVariable = "IsDonker" 
var idx_rainrate = '58'
var idx_rainforecast = '57'
...
$(document).ready(function() {
	...
	$.domoticzurl="http://192.168.0.160:8080";
	...
	$.PageArray = [
		...
		['53','Temp',		'cell1a',	'Buiten','1','0'], //Lastseen only from cell_a possible
		['53','Chill',	    'cell1b',	'Buiten','0','0'],
		['0','Desc',		'cell2',	'Wind','0','0'],
		['53','DirectionStr','cell2a',	'Wind richting','0','0'],
		['53','Speed',		'cell2b',	'Wind snelheid','0','0'],
		['0','Status',		'cell4',	'Zon','0','0'],
		['0','Data',		'cell4a',	'Kamer','1','0'],
		['0','Data',		'cell4b',	'Buiten','0','0'],
		['0','Desc',		'cell5',	'Regen','0','0'],
		['58','Data',		'cell5a',	'Intensiteit','0','0'],
		['57','Data',		'cell5b',	'Verwacht','0','0'],
		...
		['50','Temp',		'cell13',	'Temp Woonkamer','0','0'],
		['46','Data',		'cell14',	'Lux Woonkamer','0','0'], 
		['33','Temp',		'cell15',	'Temp Aquarium','0','0'],
		...
		['60','Level',		'cell21',	'Play','0','0'],
		['0','Tijd',		'cell22',	'Tijd','0','0'],
		['62','Data',		'cell22',	'Text','0','0'],
		['61','Level',		'cell23',	'Volume','0','1'],
		['0','SunBoth',		'cell26',	'Dummy cel voor bepaling zon op en zon onder','0','0'],
		['0','Desc',		'cell2_1',	'Barometer + zicht','0','0'],
		['24','Barometer',	'cell2_1a',	'Barometer','1','0'],
		['26','Visibility','cell2_1b',	'Zicht','0','0'],
		['0','Desc',		'cell2_2',	'Zon','0','0'],
		['39','Data',		'cell2_2a',	'Altitude','1','0'],
		['38','Data',		'cell2_2b',	'Azimuth','1','0'],
