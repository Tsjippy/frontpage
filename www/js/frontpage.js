...
function RefreshData(){
	...
	//console.log(vdata);
								...
								}else if(item.idx == idx_WindRichting){
								...
								//	vdata=new String(vdata).replace( "On", "Dicht");
									...
									vdata=new String(vdata).split("mm/h",1)[0];
